      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto d-flex align-items-center gap-4">
            ...
            <Link to="/fav" className="nav-link custom-icon"><MdFavoriteBorder /> <Badge bg="secondary">{getFav.length}</Badge>
</Link>
            <Link to="/cart" className="nav-link custom-icon"><IoCartOutline /> <Badge bg="secondary">{getCart.length}</Badge>
</Link>
          </Nav>
        </Navbar.Collapse>
      </Container>
